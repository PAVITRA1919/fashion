...
@click.option('--autogenerate', is_flag=True,
              help=('Populate revision script with candidate migration '
                    'operations, based on comparison of db to model'))
@click.option('--sql', is_flag=True,
              help=('Don\'t emit SQL to db - dump to standard output '
                    'instead'))
...
def current(directory, verbose):
    """Display the current revision for each db."""
