...
def compare_metadata(context: MigrationContext, metadata: MetaData) -> Any:
    """Compare a db schema to that given in a
    :class:`~sqlalchemy.schema.MetaData` instance.

    The db connection is presented in the context
    of a :class:`.MigrationContext` object, which
    provides db connectivity as well as optional
...
class AutogenContext:
    ...
    objects as stated in the current db model, and represents the
    destination structure for the db being examined.
    ...
    connected to the db backend being compared.
    ...
    def inspector(self) -> Inspector:
        if self.connection is None:
            raise TypeError(
                ...
                "AutogenContext has no db connection"
            )
    ...
    def run_name_filters(
        ...
        the chance to filter what names should be reflected as db
    ...
    def _run_environment(
        ...
        if autogenerate:
            ...
            if set(self.script_directory.get_revisions(rev)) != set(
                ...
                raise util.CommandError("Target db is not up to date.")
