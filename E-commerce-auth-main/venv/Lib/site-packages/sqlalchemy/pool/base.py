...
class Pool(log.Identified, event.EventTarget):
    ...
    def __init__(
         ...
         * ``"commit"`` - call commit() on the connection,
           to release locks and transaction resources.
           A commit here may be desirable for dbs that
         ...
         * ``None`` - don't do anything on the connection.
           This setting may be appropriate if the db / DBAPI
...
class ManagesConnection:
    ...
    :attr:`.ManagesConnection.dbapi_connection`.   For an asyncio db
...
class ConnectionPoolEntry(ManagesConnection):
    """Interface for the object that maintains an individual db
...
class _ConnectionFairy(PoolProxiedConnection):
    ...
    def _checkout(
        ...
        # as the pre-pinger.
        # there are three attempts made here, but note that if the db
