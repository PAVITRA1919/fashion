...
"""Global db feature support policy.
...
class SuiteRequirements(Requirements):
    ...
    def uuid_data_type(self):
        """Return dbs that support the UUID datatype."""

        return exclusions.closed()

    @property
    def foreign_keys(self):
        """Target db must support foreign keys."""

        return exclusions.open()

    @property
    def foreign_keys_reflect_as_index(self):
        """Target db creates an index that's reflected for
        foreign keys."""
    ...
    def unique_index_reflect_as_unique_constraints(self):
        """Target db reflects unique indexes as unique constrains."""

        return exclusions.closed()

    @property
    def unique_constraints_reflect_as_index(self):
        """Target db reflects unique constraints as indexes."""

        return exclusions.closed()

    @property
    def table_value_constructor(self):
        """db / dialect supports a query like::
    ...
    def standard_cursor_sql(self):
        """Target db passes SQL-92 style statements to cursor.execute()
    ...
    def on_update_cascade(self):
        """target db must support ON UPDATE..CASCADE behavior in
        foreign keys."""
    ...
    def non_updating_cascade(self):
        """target db must *not* support ON UPDATE..CASCADE behavior in
        foreign keys."""
        return exclusions.closed()
    ...
    def self_referential_foreign_keys(self):
        """Target db must support self-referential foreign keys."""

        return exclusions.open()

    @property
    def foreign_key_ddl(self):
        """Target db must support the DDL phrases for FOREIGN KEY."""

        return exclusions.open()

    @property
    def named_constraints(self):
        """target db must support names for constraints."""

        return exclusions.open()

    @property
    def implicitly_named_constraints(self):
        """target db must apply names to unnamed constraints."""

        return exclusions.open()

    @property
    def unusual_column_name_characters(self):
        """target db allows column names that have unusual characters
    ...
    @property
    def subqueries(self):
        """Target db must support subqueries."""

        return exclusions.open()

    @property
    def offset(self):
        """target db can render OFFSET, or an equivalent, in a
        SELECT.
        """
    ...
    def bound_limit_offset(self):
        """target db can render LIMIT and/or OFFSET using a bound
        parameter
        """
    ...
    def sql_expression_limit_offset(self):
        """target db can render LIMIT and/or OFFSET with a complete
    ...
    def parens_in_union_contained_select_w_limit_offset(self):
        """Target db must support parenthesized SELECT in UNION
    ...
    def boolean_col_expressions(self):
        """Target db must support boolean expressions as columns"""

        return exclusions.closed()

    @property
    def nullable_booleans(self):
        """Target db allows boolean columns to store NULL."""
    ...
    def standalone_binds(self):
        """target db/driver supports bound parameters as column
    ...
    def standalone_null_binds_whereclause(self):
        """target db/driver supports bound parameters with NULL in the
    ...
    @property
    def intersect(self):
        """Target db must support INTERSECT or equivalent."""
        return exclusions.closed()

    @property
    def except_(self):
        """Target db must support EXCEPT or equivalent (i.e. MINUS)."""
        return exclusions.closed()

    @property
    def window_functions(self):
        """Target db must support window functions."""
        return exclusions.closed()

    @property
    def ctes(self):
        """Target db supports CTEs"""

        return exclusions.closed()

    @property
    def ctes_with_update_delete(self):
        """target db supports CTES that ride on top of a normal UPDATE
    ...
    def ctes_on_dml(self):
        """target db supports CTES which consist of INSERT, UPDATE
    ...
    def delete_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(db)s %(does_support)s 'DELETE ... RETURNING'",
        )
    ...
    def insert_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(db)s %(does_support)s 'INSERT ... RETURNING'",
        )
    ...
    def update_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(db)s %(does_support)s 'UPDATE ... RETURNING'",
        )
    ...
    def insert_executemany_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(db)s %(does_support)s 'RETURNING of "
    ...
    def insertmanyvalues(self):
        return exclusions.only_if(
            ...
            "%(db)s %(does_support)s 'insertmanyvalues functionality",
        )
    ...
    def denormalized_names(self):
        """Target db must have 'denormalized', i.e.
    ...
    def multivalues_inserts(self):
        """target db must support multiple VALUES clauses in an
        INSERT statement."""
    ...
    def emulated_lastrowid(self):
        ...
        from a db-side function after an insert() construct executes,
    ...
    @property
    def views(self):
        """Target db must support VIEWs."""

        return exclusions.closed()

    @property
    def schemas(self):
        """Target db must support external schemas, and have one
        named 'test_schema'."""
    ...
    @property
    def sequences(self):
        """Target db must support SEQUENCEs."""
    ...
    def sequences_optional(self):
        """Target db supports sequences, but also optionally
    ...
    def supports_lastrowid(self):
        """target db / driver supports cursor.lastrowid as a means
    ...
    def table_reflection(self):
        """target db has general support for table reflection"""
        return exclusions.open()

    @property
    def reflect_tables_no_columns(self):
        """target db supports creation and reflection of tables with no
    ...
    def comment_reflection(self):
        """Indicates if the db support table comment reflection"""
        return exclusions.closed()

    @property
    def comment_reflection_full_unicode(self):
        """Indicates if the db support table comment reflection in the
    ...
    def constraint_comment_reflection(self):
        """indicates if the db support comments on constraints
        and their reflection"""
        return exclusions.closed()

    @property
    def view_column_reflection(self):
        """target db must support retrieval of the columns in a view,
    ...
    def view_reflection(self):
        """target db must support inspection of the full CREATE VIEW
        definition."""
        return self.views
    ...
    def schema_create_delete(self):
        """target db supports schema create and dropped with
    ...
    def temporary_tables(self):
        """target db supports temporary tables"""
        return exclusions.open()

    @property
    def temporary_views(self):
        """target db supports temporary views"""
        return exclusions.closed()
    ...
    def indexes_with_ascdesc(self):
        """target db supports CREATE INDEX with per-column ASC/DESC."""
        return exclusions.open()

    @property
    def reflect_indexes_with_ascdesc(self):
        """target db supports reflecting INDEX with per-column
        ASC/DESC."""
        return exclusions.open()
    ...
    def indexes_with_expressions(self):
        """target db supports CREATE INDEX against SQL expressions."""
        return exclusions.closed()

    @property
    def reflect_indexes_with_expressions(self):
        """target db supports reflection of indexes with
        SQL expressions."""
        return exclusions.closed()
    ...
    def unbounded_varchar(self):
        """Target db must support VARCHAR with no length"""

        return exclusions.open()

    @property
    def unicode_data_no_special_types(self):
        """Target db/dialect can receive / deliver / compare data with
    ...
    def unicode_data(self):
        """Target db/dialect must support Python unicode objects with
    ...
    def date_implicit_bound(self):
        ...
        that the db server knows the object is a date, and not
        a plain string.
    ...
    def time_implicit_bound(self):
        ...
        that the db server knows the object is a time, and not
        a plain string.
    ...
    def datetime_implicit_bound(self):
        ...
        that the db server knows the object is a datetime, and not
        a plain string.
    ...
    def timestamp_microseconds_implicit_bound(self):
        ...
        will bind it such that the db server knows
    ...
    def binary_comparisons(self):
        """target db/driver can allow BLOB/BINARY fields to be compared
    ...
    def nested_aggregates(self):
        """target db can select an aggregate from a subquery that's
    ...
    def recursive_fk_cascade(self):
        """target db must support ON DELETE CASCADE on a self-referential
        foreign key
    ...
    @property
    def text_type(self):
        """Target db must support an unbounded Text() "
    ...
    def empty_strings_varchar(self):
        """target db can persist/return an empty string with a
        varchar.
    ...
    def empty_strings_text(self):
        """target db can persist/return an empty string with an
        unbounded text."""
    ...
    def expressions_against_unbounded_text(self):
        """target db supports use of an unbounded textual field in a
        WHERE clause."""
    ...
    @property
    def savepoints(self):
        """Target db must support savepoints."""

        return exclusions.closed()

    @property
    def two_phase_transactions(self):
        """Target db must support two-phase transactions."""
    ...
    def mod_operator_as_percent_sign(self):
        """target db must use a plain percent '%' as the 'modulus'
        operator."""
        return exclusions.closed()
    ...
    def order_by_col_from_union(self):
        """target db supports ordering by a column from a SELECT
        inside of a UNION
    ...
    def order_by_label_with_expression(self):
        ...
        Lots of dbs including PostgreSQL don't support this,
    ...
    def independent_connections(self):
        """
        Target must support simultaneous, independent db connections.
        """
        return exclusions.open()
    ...
    def reflect_table_options(self):
        """Target db must support reflecting table_options."""
        return exclusions.closed()

    @property
    def materialized_views(self):
        """Target db must support MATERIALIZED VIEWs."""
        return exclusions.closed()

    @property
    def materialized_views_reflect_pk(self):
        """Target db reflect MATERIALIZED VIEWs pks."""
        return exclusions.closed()

    @property
    def supports_bitwise_or(self):
        """Target db supports bitwise or"""
        return exclusions.closed()

    @property
    def supports_bitwise_and(self):
        """Target db supports bitwise and"""
        return exclusions.closed()

    @property
    def supports_bitwise_not(self):
        """Target db supports bitwise not"""
        return exclusions.closed()

    @property
    def supports_bitwise_xor(self):
        """Target db supports bitwise xor"""
        return exclusions.closed()

    @property
    def supports_bitwise_shift(self):
        """Target db supports bitwise left or right shift"""
        return exclusions.closed()
