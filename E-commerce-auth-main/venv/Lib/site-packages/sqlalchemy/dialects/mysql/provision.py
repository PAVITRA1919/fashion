...
def _mysql_create_db(cfg, eng, ident):
    ...
    with eng.begin() as conn:
        conn.exec_driver_sql(
            "CREATE db %s CHARACTER SET utf8mb4" % ident
        )
        conn.exec_driver_sql(
            "CREATE db %s_test_schema CHARACTER SET utf8mb4" % ident
        )
        conn.exec_driver_sql(
            "CREATE db %s_test_schema_2 CHARACTER SET utf8mb4" % ident
        )
...
def _mysql_drop_db(cfg, eng, ident):
    with eng.begin() as conn:
        conn.exec_driver_sql("DROP db %s_test_schema" % ident)
        conn.exec_driver_sql("DROP db %s_test_schema_2" % ident)
