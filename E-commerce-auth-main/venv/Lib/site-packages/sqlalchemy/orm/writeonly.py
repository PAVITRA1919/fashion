        ...
        if apply_to:
            if passive & PassiveFlag.SQL_OK:
                raise exc.InvalidRequestError(
                    ...
                    "db for this operation; full iteration is not "
...
class WriteOnlyCollection(AbstractCollectionWriter[_T]):
    ...
    def add_all(self, iterator: Iterable[_T]) -> None:
        ...
        The given items will be persisted to the db in terms of
    ...
    def add(self, item: _T) -> None:
        ...
        The given item will be persisted to the db in terms of
        the parent instance's collection on the next flush.
