...
def identity_key(
    ...
    * ``identity_key(instance=instance)``
      ...
      effect of performing a db check for the corresponding row
    ...
    * ``identity_key(class, row=row, identity_token=token)``
      ...
      db result row as a :class:`.Row` or :class:`.RowMapping` object.
...
def has_identity(object_: object) -> bool:
    """Return True if the given object has a db
    identity.
