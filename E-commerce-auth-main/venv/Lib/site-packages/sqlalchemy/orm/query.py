...
construct used by the ORM to construct db queries.

The :class:`_query.Query` class should not be confused with the
:class:`_expression.Select` class, which defines db
SELECT operations at the SQL (non-ORM) level.  ``Query`` differs from
``Select`` in that it returns ORM-mapped objects and interacts with an
ORM session, whereas the ``Select`` construct interacts directly with the
db to return iterable result sets.
...
class Query(
    ...
    def with_for_update(
        ...
        *,
        ...
        .. warning::
            ...
            db backends.  When ``with_for_update`` is successfully used
    ...
    def union(self, *q: Query[Any]) -> Self:
        ...
        Note that many db backends do not allow ORDER BY to
    ...
    def join(
        ...
        **Simple Relationship Joins**
        ...
        .. note:: as seen in the above example, **the order in which each
           ...
           SQL in which case the db will raise an error. In correct
           practice, the
    ...
    def distinct(self, *expr: _ColumnExpressionArgument[Any]) -> Self:
        ...
        .. note::
            ...
            of the db backend that ORDER BY columns be part of the SELECT
    ...
    def exists(self) -> Exists:
        ...
        Note that some dbs such as SQL Server don't allow an
    ...
    def delete(
        ...
        Deletes rows matched by this query from the db.
        ...
        :return: the count of rows matched as returned by the db's
          "row count" feature.
    ...
    def update(
        ...
        Updates rows matched by this query in the db.
