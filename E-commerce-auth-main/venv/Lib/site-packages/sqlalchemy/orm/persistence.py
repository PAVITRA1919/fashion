...
def _postfetch(
    ...
    """Expire attributes in need of newly persisted db state,
    ...
    for c in prefetch_cols:
        if c.key in params and c in mapper._columntoproperty:
            ...
            # since this is new db state that replaces whatever might
    ...
    if isupdate and value_params:
        ...
        # db which are set to themselves in order to do a version bump.
