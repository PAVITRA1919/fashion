...
configurational unit which associates a class with a db table.
...
class Mapper(
    ...
    """Defines an association between a Python class and a db table or
    ...
    def __init__(
        ...
        :param always_refresh: If True, all query operations for this mapped
           ...
           whatever information was loaded from the db. Usage of this
           flag is highly discouraged; as an alternative, see the method
           :meth:`_query.Query.populate_existing`.

        :param allow_partial_pks: Defaults to True.  Indicates that a
           composite primary key with some NULL values should be considered as
           possibly existing within the db. This affects whether a
           mapper will assign an incoming row to an existing identity, as well
           as if :meth:`.Session.merge` will check the db first for a
           ...
           db, or if a load attempt is not necessary.
        ...
        :param confirm_deleted_rows: defaults to True; when a DELETE occurs
          ...
          case where db ON DELETE CASCADE rules may be deleting some of
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          INSERT should be fetched using ``RETURNING`` if the backing db
          supports it and if the dialect in use supports "insertmanyreturning"
          for an INSERT statement. If the backing db does not support
        ...
        :param passive_updates: Indicates UPDATE behavior of foreign key
           ...
           the foreign key in the db, and that the db will handle
           propagation of an UPDATE from a source column to dependent columns
           on joined-table rows.

           When False, it is assumed that the db does not enforce
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          of the discriminator should be persisted to the db,
          the value of the
    ...
    def identity_key_from_instance(self, instance: _O) -> _IdentityKeyType[_O]:
        ...
        will result in a db check to see if the object has been deleted.
...
def reconstructor(fn):
    ...
    loaded from the db or otherwise reconstituted.
    ...
    (non-collection) db-mapped attributes of the instance will
