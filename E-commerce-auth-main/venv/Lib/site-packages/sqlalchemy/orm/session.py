...
class ORMExecuteState(util.MemoizedSlots):
    ...
    arguments that will assist in determining amongst a set of db
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param autoflush: When ``True``, all query operations will issue a
           ...
           not be called repeatedly in order for db queries to retrieve
           results.
        ...
        :param autobegin: Automatically start transactions (i.e. equivalent to
           invoking :meth:`_orm.Session.begin`) when db access is
        ...
        :param expire_on_commit:  Defaults to ``True``. When ``True``, all
           ...
           transaction will load from the most recent db state.
        ...
        :param twophase:  When ``True``, all transactions will be started as
            ...
            of the db in use along with an XID.  During a
            :meth:`~.commit`, after :meth:`~.flush` has been issued for all
            attached dbs, the :meth:`~.TwoPhaseTransaction.prepare`
            method on each db's :class:`.TwoPhaseTransaction` will be
            called. This allows each db to roll back the entire
        ...
        :param join_transaction_mode: Describes the transactional behavior to
          ...
          * ``"create_savepoint"`` - the :class:`_orm.Session` will use
            ...
            :class:`_engine.Connection`; if the underlying db and
    ...
    def begin_nested(self) -> SessionTransaction:
        ...
        The target db(s) and associated drivers must support SQL
    ...
    def rollback(self) -> None:
        ...
        the topmost db transaction, discarding any nested
    ...
    def commit(self) -> None:
        ...
        normally affect the db unless pending flush changes were
        detected, but will still invoke event handlers and object expiration
        rules.

        The outermost db transaction is committed unconditionally,
    ...
    def close(self) -> None:
        ...
        .. tip::
            ...
            the :class:`_orm.Session` will release all db connections
            and ORM objects.
        ...
        .. versionchanged:: 1.4  The :meth:`.Session.close` method does not
           ...
           the :class:`.Session` is used again for a db operation.
    ...
    def invalidate(self) -> None:
        ...
        This can be called when the db is known to be in a state where
    ...
    def no_autoflush(self) -> Iterator[Session]:
        ...
        of objects which involve existing db queries,
    ...
    def refresh(
        ...
        the db to refresh column-oriented attributes with the current
        ...
        in db state outside of that transaction.   Refreshing
        attributes usually only makes sense at the start of a transaction
        where db rows have not yet been accessed.
    ...
    def expire_all(self) -> None:
        ...
        in db state outside of that transaction.
            ...
            if obj is not None:
                ...
                if (
                    ...
                    raise exc.FlushError(
                        ...
                        "auto-generated value, check that the db table "
    ...
    def merge(
        ...
        *,
        ...
        to load the object from the db based on primary key, and if
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         events as well as all db access.  This flag is used for
        ...
        :param options: optional sequence of loader options which will be
         ...
         operation loads the existing version of the object from the db.
    ...
    def enable_relationship_loading(self, obj: object) -> None:
        ...
        will attempt to load a value from the db using this
        ...
        **not** participate in any persistence operations; its state
        ...
        If the object instead represents an existing identity in the db,
    ...
    def flush(self, objects: Optional[Sequence[Any]] = None) -> None:
        """Flush all the object changes to the db.

        Writes out all pending object creations, deletions and modifications
        to the db as INSERTs, DELETEs, UPDATEs, etc.  Operations are
        automatically ordered by the Session's unit of work dependency
        solver.

        db operations will be issued in the current transactional
        context and do not affect the state of the transaction, unless an
        error occurs, in which case the entire transaction is rolled back.
        You may flush() as often as you like within a transaction to move
        changes from Python to the db's transaction buffer.
        ...
        try:
            ...
            if not objects and self.identity_map._modified:
                ...
                util.warn(
                    ...
                    "reset, and will not result in db updates. "
    ...
    def is_modified(
        ...
        * Instances present in the :attr:`.Session.dirty` collection may
          ...
          is the same as that loaded from the db, resulting in no net
          change here.
        * Scalar attributes may not have recorded the previously set
          value when a new value was applied, if the attribute was not loaded,
          or was expired, at the time the new value was received - in these
          cases, the attribute is assumed to have a change, even if there is
          ultimately no net change against its db value. SQLAlchemy in
...
class sessionmaker(_SessionClassMethods, Generic[_S]):
    ...
    takes place even if there are db errors::
...
def make_transient(instance: object) -> None:
    ...
    .. warning::
        ...
        * were not present in the query which loaded this object, such as that
        ...
        As the object is transient and un-associated with any db
