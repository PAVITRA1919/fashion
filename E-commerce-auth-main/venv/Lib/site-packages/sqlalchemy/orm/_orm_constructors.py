...
def orm_insert_sentinel(
    ...
    *,
    ...
    the db table itself also needs to have a column with this name
    present.
...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param expire_on_flush=True:
        ...
        db state.   For this reason a column_property()'s value
    ...
    **kw: Any,
    ...
    :param foreign_keys:
      ...
      :paramref:`_orm.relationship.foreign_keys` is only needed when:
        ...
        2. The :class:`_schema.Table` being mapped does not actually have
           ...
           was reflected from a db that does not support foreign key
    ...
    :param lazy='select': specifies
      ...
      * ``write_only`` - the attribute will be configured with a special
        ...
        iterate the full set of objects from the db directly. Instead,
    ...
    :param passive_deletes=False:
       ...
       scenario is in place on the db side.  Note that the foreign
    ...
    :param passive_updates=True:
      ...
      the foreign key in the db, and that the db will
      ...
      the db is in fact enforcing referential integrity, unless
      ...
      and instead uses the referential integrity features of the db
...
def aliased(
    ...
    :param flat: Boolean, will be passed through to the
     ...
     supported by all modern dbs with regards to right-nested joins
