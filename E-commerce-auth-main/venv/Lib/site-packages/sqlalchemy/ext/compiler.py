...
* :class:`~sqlalchemy.sql.functions.FunctionElement` - This is a hybrid of a
  ...
  function or stored procedure type of call. Since most dbs support
...
stored in relational dbs as UTC, without time zones.   UTC so that your
db doesn't think time has gone backwards in the hour when daylight
