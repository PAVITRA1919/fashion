...
class AsyncSession(ReversibleProxy[Session]):
    ...
    async def refresh(
        ...
        A query will be issued to the db and all attributes will be
        refreshed with their current db value.
    ...
    async def run_sync(
        ...
        **kw: _P.kwargs,
        ...
        to the db connection by running the given callable in a
        ...
        .. tip::
            ...
            callable should only call into SQLAlchemy's asyncio db
    ...
    async def delete(self, instance: object) -> None:
        ...
        The db delete operation occurs upon ``flush()``.
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        at the point of invoking IO on the db drivers.
    ...
    async def connection(
        ...
        **kw: Any,
        ...
        db connection used by the current transaction.
    ...
    def begin(self) -> AsyncSessionTransaction:
        ...
        Note that db IO will not normally occur when the session-level
        transaction is begun, as db transactions begin on an
