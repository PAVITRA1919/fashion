...
collection, and not the initial load from the db, and requires that the
...
class OrderingList(List[_T]):
    ...
    def __init__(
        ...
        :param reorder_on_append:
          ...
          variety of dangerous unexpected db writes.

          SQLAlchemy will add instances to the list via append() when your
          object loads.  If for some reason the result set from the db
