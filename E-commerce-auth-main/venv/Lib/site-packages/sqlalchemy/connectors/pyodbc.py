...
class PyODBCConnector(Connector):
    ...
    def create_connect_args(self, url: URL) -> ConnectArgsType:
        ...
        if "odbc_connect" in keys:
            ...
            dsn_connection = "dsn" in keys or (
                "host" in keys and "db" not in keys
            )
            if dsn_connection:
                connectors = [
            ...
            # convert textual data from your db encoding to your
            # client encoding.  This should obviously be set to 'No' if
            # you query a cp1253 encoded db from a latin1 client...
    ...
    def _get_server_version_info(
        ...
        # freetds is in use.   Implement db-specific server version
        # queries.
