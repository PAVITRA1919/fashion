...
class UpdateBase(
    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        4. An INSERT statement invoked with executemany() is supported if the
           backend db driver supports the
    ...
    def returning(
        ...
        **__kw: Any,
        ...
        Upon compilation, a RETURNING clause, or db equivalent,
        ...
        Note that not all dbs/DBAPIs
        support RETURNING.   For those backends with no support,
        an exception is raised upon compilation and/or execution.
        For those who do support it, the functionality across backends
        varies greatly, including restrictions on executemany()
        and other statements which return multiple rows. Please
        read the documentation notes for the db in use in
    ...
    def values(
        ...
        **kwargs: Any,
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         method, which is supported by all db backends and is generally
...
class Insert(ValuesBase):
    ...
    def from_select(
        ...
        :param select: a :func:`_expression.select` construct,
         ...
         is not checked before passing along to the db, the db
...
class DMLWhereBase:
    ...
    def where(self, *whereclause: _ColumnExpressionArgument[bool]) -> Self:
        ...
        support multiple-table forms, including db-specific
