...
class DDLEvents(event.Events[SchemaEventTarget]):
    ...
    **Create / Drop Events**
    ...
    Events emitted when CREATE and DROP commands are emitted to the db.
    ...
    **Reflection Events**
    ...
    and modify the in-Python definition of db columns when
    :term:`reflection` of db tables proceeds.
