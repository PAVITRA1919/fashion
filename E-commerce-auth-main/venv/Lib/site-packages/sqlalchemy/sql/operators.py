...
class Operators:
    ...
    def op(
        ...
        :param precedence: precedence which the db is expected to apply
        ...
        :param python_impl: an optional Python function that can evaluate
         ...
         run on the db server.  Useful for in-Python SQL expression
...
class ColumnOperators(Operators):
    ...
    def __getitem__(self, index: Any) -> ColumnOperators:
        ...
        This can be used by some db-specific types
    ...
    def in_(self, other: Any) -> ColumnOperators:
        ...
        * A bound parameter, e.g. :func:`.bindparam`, may be used if it
          ...
          The db would be passed a bound parameter for each value::
          ...
          which is specific to the db in use, is rendered.  On
    ...
    def startswith(
        ...
        :param escape: a character which when given will render with the
          ...
          ``"foo^%bar^^bat"`` before being passed to the db.
    ...
    def match(self, other: Any, **kwargs: Any) -> ColumnOperators:
        """Implements a db-specific 'match' operator.
    ...
    def regexp_match(
        ...
        """Implements a db-specific 'regexp match' operator.
    ...
    def regexp_replace(
        ...
        """Implements a db-specific 'regexp replace' operator.
