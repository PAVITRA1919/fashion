...
class Compiled:
    ...
    specific to their underlying db dialect, and also may
...
class SQLCompiler(Compiled):
    ...
    concern for characters that aren't allowed at all on the target db.
...
class IdentifierPreparer:
    ...
    def __init__(
        ...
        omit_schema
          Prevent prepending schema name. Useful for dbs that do
          not support schemae.
        """
    ...
    def _escape_identifier(self, value: str) -> str:
        ...
        Subclasses should override this to provide db-dependent
        escaping behavior.
        """
    ...
    def quote_schema(self, schema: str, force: Any = None) -> str:
        ...
        Subclasses can override this to provide db-dependent
    ...
    def format_table_seq(self, table, use_schema=True):
        ...
        # ('db', 'owner', etc.) could override this and return
        # a longer sequence.
