...
class HasHints:
    ...
    def with_statement_hint(self, text: str, dialect_name: str = "*") -> Self:
        ...
        Hints here are specific to the backend db and may include
        ...
        .. seealso::
            ...
            which also can suit some db-specific HINT syntaxes such as
    ...
    def with_hint(
        ...
        location for the db backend in use, relative
...
class Alias(roles.DMLTableRole, FromClauseAlias):
    ...
    without the keyword on certain dbs such as Oracle).
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def cte(
        ...
        and DELETE on some dbs, both as a source of CTE rows
...
class GenerativeSelect(SelectBase, Generative):
    ...
    def with_for_update(
        ...
        *,
        ...
        On a db like PostgreSQL or Oracle, the above would render a
        statement like::
        ...
        provided which allow for common db-specific
        variants.
    ...
    def join(
        ...
        *,
        ...
        .. versionchanged:: 1.4 :meth:`_expression.Select.join` now creates
           ...
           most dbs in any case.   The new behavior is modeled after
