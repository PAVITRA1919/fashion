...
class DBAPIConnection(Protocol):
    """protocol representing a :pep:`249` db connection.
...
class DBAPIType(Protocol):
    """protocol representing a :pep:`249` db type.
...
class DBAPICursor(Protocol):
    """protocol representing a :pep:`249` db cursor.
...
class ReflectedColumn(TypedDict):
    ...
    """db-dependent autoincrement flag.

    This flag indicates if the column has a db-side "autoincrement"
    ...
    """indicates that this column is computed by the db.
    Only some dialects return this key.
...
class ReflectedIndex(TypedDict):
    ...
    """columns to include in the INCLUDE clause for supporting dbs.
...
class BindTyping(Enum):
    ...
    bound parameters in a statement to the db driver.
    ...
    NONE = 1
    """No steps are taken to pass typing information to the db driver.

    This is the default behavior for dbs such as SQLite, MySQL / MariaDB,
    SQL Server.
...
class Dialect(EventTarget):
    """Define the behavior of a specific db and DB-API combination.

    Any aspect of metadata definition, SQL query generation,
    execution, result-set handling, or anything else which varies
    between dbs is defined under the general category of the
    Dialect.  The Dialect acts as a factory for other
    db-specific object implementations including
    ...
    typically populated during the initial connection to the db.
    """
    ...
    supports_alter: bool
    """``True`` if the db supports ``ALTER TABLE`` - used only for
    ...
    Most dbs support this in some way, e.g. SQLite supports it using
    ...
    """Target db supports INSERT...VALUES with multiple value
    sets, i.e. INSERT INTO table (cols) VALUES (...), (...), (...), ...

    """

    insert_executemany_returning: bool
    """dialect / driver / db supports some means of providing
    ...
    """Options indicating the db supports a form of bulk INSERT where
    ...
    """target db supports IDENTITY"""

    cte_follows_insert: bool
    """target db, when given a CTE with an INSERT statement, needs
    ...
    """define a means of passing typing information to the db and/or
    ...
    """target db supports ORDER BY <labelname>, where <labelname>
    refers to a label in the columns clause of the SELECT"""

    div_is_floordiv: bool
    """target db treats the / division operator as "floor division" """

    tuple_in_values: bool
    """target db supports tuple IN, i.e. (x, y) IN ((q, p), (r, z))"""
    ...
    def get_sequence_names(
        ...
        """Return a list of all sequence names available in the db.
    ...
    def get_schema_names(self, connection: Connection, **kw: Any) -> List[str]:
        """Return a list of all schema names available in the db.
        ...
        **kw: Any,
        ...
        .. versionchanged:: 2.0:: :meth:`_engine.Dialect.has_table` now
           ...
           * temporary tables of any kind
           ...
           and dialects to the degree that the backing db supports views
    ...
    def has_index(
        ...
        **kw: Any,
        ...
        """Check the existence of a particular index name in the db.
    ...
    def has_sequence(
        ...
        **kw: Any,
        ...
        """Check the existence of a particular sequence in the db.

        Given a :class:`_engine.Connection` object and a string
        `sequence_name`, return ``True`` if the given sequence exists in
        the db, ``False`` otherwise.
    ...
    def has_schema(
        ...
        """Check the existence of a particular schema name in the db.
...
class CreateEnginePlugin:
    ...
    names can be added to the db URL.  Target applications for
    ...
    * connectivity plugins such as proxies
    ...
    A plugin that uses the above names would be invoked from a db
    URL as in::
