...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param isolation_level: Available on: :class:`_engine.Connection`,
          ...
          semi-db specific; see individual dialect documentation for
          valid levels.
          ...
          .. note:: The ``isolation_level`` execution option may only be
             ...
             :meth:`_engine.Connection.rollback`. A db cannot change the
        ...
        :param stream_results: Available on: :class:`_engine.Connection`,
          ...
          in batches, to allow for efficient iteration of db rows while
    ...
    def get_isolation_level(self) -> IsolationLevel:
        ...
        the db within the scope of this connection.

        This attribute will perform a live SQL operation against the db
        ...
        .. note::  This method **will not report** on the ``AUTOCOMMIT``
          ...
          in use, the db connection still has a "traditional" isolation
    ...
    def default_isolation_level(self) -> Optional[IsolationLevel]:
        ...
        db for the current isolation level before any additional commands
        have been emitted.
    ...
    def begin(self) -> RootTransaction:
        ...
        From a db point of view, the :meth:`_engine.Connection.begin`
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        db, else the behavior is undefined. SAVEPOINT is commonly used to
    ...
    def commit(self) -> None:
        ...
        .. note:: The :meth:`_engine.Connection.commit` method only acts upon
          the primary db transaction that is linked to the
    ...
    def rollback(self) -> None:
        ...
        .. note:: The :meth:`_engine.Connection.rollback` method only acts
          upon the primary db transaction that is linked to the
          :class:`_engine.Connection` object.  It does not operate upon a
          SAVEPOINT that would have been invoked from the
          :meth:`_engine.Connection.begin_nested` method; for control of a
    ...
    def close(self) -> None:
        ...
        This results in a release of the underlying db
...
class Transaction(TransactionalContext):
    """Represent a db transaction in progress.
    ...
    def rollback(self) -> None:
        ...
        * For a simple db transaction (e.g. :class:`.RootTransaction`),
...
class Engine(
    ...
    source of db connectivity and behavior.
    ...
    def execution_options(self, **opt: Any) -> OptionEngine:
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        to change the current schema on a db connection::
        ...
        to switch dbs before a statement execution, while at the same
        time keeping track of which db we've established using the
    ...
    def dispose(self, close: bool = True) -> None:
        ...
        :param close: if left at its default of ``True``, has the
         ...
         db connections.  Connections that are still checked out
