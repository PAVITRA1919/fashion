...
class FullyBufferedCursorFetchStrategy(CursorFetchStrategy):
    ...
    after the db conversation can not be continued,
...
class CursorResult(Result[_T]):
    ...
    Returns db rows via the :class:`.Row` class, which provides
    ...
    def _init_metadata(self, context, cursor_description):
        if context.compiled:
            ...
            # be using the cached Column objects against this db result
    ...
    def inserted_primary_key(self):
        ...
        :class:`_schema.Column`), and were generated using the db-side
