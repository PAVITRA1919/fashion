...
to db dialect authors; dialects will usually use the classes here
...
class DefaultDialect(Dialect):
    ...
    def loaded_dbapi(self) -> ModuleType:
        if self.dbapi is None:
            raise exc.InvalidRequestError(
                ...
                "and cannot be used for actual db interaction"
            )
        return self.dbapi
    ...
    def get_default_isolation_level(self, dbapi_conn):
        ...
        "fallback" isolation level for dbs that cannot reliably
    ...
    def type_descriptor(self, typeobj):
        """Provide a db-specific :class:`.TypeEngine` object, given
