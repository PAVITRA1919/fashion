...
class ConnectionEvents(event.Events[ConnectionEventsTarget]):
    ...
    to the db.  The :meth:`.before_cursor_execute` event is
    ...
    def before_execute(
        ...
        as early manipulation of the parameters being sent to the db,
    ...
    def engine_connect(self, conn: Connection) -> None:
        ...
        refers to the actual connection to a db at the DBAPI level;
...
class DialectEvents(event.Events[Dialect]):
    ...
    def handle_error(
        ...
        * Establishing whether a DBAPI connection error message indicates
          that the db connection needs to be reconnected, including
        ...
        * exception re-writing
        ...
        that rely upon disconnect codes to detect db liveness**. Note
