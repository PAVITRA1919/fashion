...
information about a db connection specification.
...
class URL(NamedTuple):
    """
    Represent the components of a URL used to connect to a db.
    ...
    * :attr:`_engine.URL.drivername`: db backend and driver name, such as
      ``postgresql+psycopg2``
    ...
    * :attr:`_engine.URL.db`: string db name
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    drivername: str
    """db backend and driver name, such as
    ``postgresql+psycopg2``
    ...
    def create(
        ...
        :param drivername: the name of the db backend. This name will
          correspond to a module in sqlalchemy/dbs or a third party
          plug-in.
        :param username: The user name.
        :param password: db password.  Is typically a string, but may
    ...
    def get_backend_name(self) -> str:
        ...
        This is the name that corresponds to the db backend in
    ...
    def translate_connect_args(
        ...
        Returns attributes of this url (`host`, `db`, `username`,
        ...
        translated = {}
        attribute_names = ["host", "db", "username", "password", "port"]
