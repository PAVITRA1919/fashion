...
"""Provides an abstraction for obtaining db schema information.
...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    subclass that
    provides additional methods specific to the dialect's target db.
    ...
    def default_schema_name(self) -> Optional[str]:
        ...
        for the current engine's db user.
    ...
    def get_table_names(
        ...
        :param schema: Schema name. If ``schema`` is left at ``None``, the
         db's default schema is
         used, else the named schema is searched.  If the db does not
    ...
    def has_index(
        ...
        **kw: Any,
        ...
        r"""Check the existence of a particular index name in the db.
